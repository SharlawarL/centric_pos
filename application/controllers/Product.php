...
class Product extends MY_Controller
{
	...
	*/
	public function addProduct(){
		...
		$this->form_validation->set_rules('code', 'Code', 'trim|required|xss_clean|is_unique[products.code]');
        ...
        else
        {
			...
			$data = array(
					...
					"barcode"		 => $this->barcode($this->input->post('barcode_id')),
					...
					"cost"           => $this->input->post('cost') + $this->input->post('add_service_value'),
					"add_service_value" => $this->input->post('add_service_value'),
