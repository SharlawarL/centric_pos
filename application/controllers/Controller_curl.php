...
class Controller_curl extends MY_Controller {
	...
	public function index(){
		...
		$this->curl->create('http://localhost/abcd-gst/api/v1/list_table');	
	...
	*/
	...
	public function get_file()
	{
	    ...
	    $host = "http://abcd.com/abcd/license.txt?t=2avxjsv1.igc";
	    //$host = "http://abcd.com/abcd/install/assets/abcdry.sql?t=2avxjsv1.igc";
	    ...
	    curl_setopt($ch, CURLOPT_REFERER, "http://abcd.com/");
