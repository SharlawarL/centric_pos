<?php 
	...
	$ledger        = $this->ledger_model->get_records();
...
?>
		<div class="col-md-12">
		  	<div class="callout callout-info">    
				...
				<p>Please create opening balance first before proceed any further <a href="<?php echo base_url('ledger/add') ?>"  class="btn btn-default text-blue">Add Opening Balance</a>
				</p>
		  	</div>  
		</div>
<?php
