...
<body>
	...
	<table width="100%" border="1" cellspacing="0" style="border: 0px solid black; border-collapse: collapse;" class="table" cellpadding="2">
		...
		<tr>
			...
			<th style="text-align: center;font-size: 12px;" colspan="2">Item Name/Description/HSN-SAC Code</th>
			...
			<tr>
				...
				<td class="fontS" colspan="2"><?php echo $value->name."<br/>".$value->hsn_sac_code; ?></td>
				...
				<td align="right" class="fontS"><?php echo $value->discount_value."<br/>(".$value->discount.")";?></td>
			...
			<tr>
				...
				<td align="right" colspan="2" class="fontH"><?php echo $data[0]->total-$data[0]->flat_discount; ?></td>
			</tr>
