			            ...
			            <div class="col-sm-12" style="overflow-y: auto;">
			            	<table class="table table-hover table-bordered">
			            		<thead>
			            			...
			            			<th width="10%"><?php echo $this->lang->line('order_status'); ?></th>
			            		...
			            		<tbody>
			            				...
			            				<td>
			            					...
			            					?>
			            							...
			            							<span style="font-size: 11px;">
			            								<a href="<?=base_url('purchase/purchaseItemReceive/'.$value->purchase_id.'/'.$value->purchase_item_id.'/'.$value->product_id.'/'.$value->quantity.'/'.$data[0]->warehouse_id)?>">Mark as Received
			            								</a>
			            							</span>
			            					<?php
			            						}else{
			            			...
			            			<tr>
			            				<td colspan="7" align="right"><b>General Discount</b><?php echo '('.$this->session->userdata('symbol').')'; ?></td>
			            				<td align="right" colspan="7"><?php echo $data[0]->flat_discount;?></td>
			            			</tr>
			            			<tr>
			            				...
			            				<td align="right" colspan="7"><?php echo $data[0]->total-$data[0]->flat_discount; ?></td>
			            			</tr>
			            		</tbody>
			            	</table>
			            </div>
