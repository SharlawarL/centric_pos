                ...
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="purchase_invoice_number" name="purchase_invoice_number" value="<?=$data[0]->purchase_invoice_number?>" >
                    ...
                    <div class="form-group">
                          ...
                          <select class="form-control select2" id="supplier" name="supplier" style="width: 100%;" disabled>
                            ...
                            <?php 
                                  ...
                                  ?>
                                          <option value='<?php echo $key->id ?>' <?php if($key->id == $data[0]->supplier_id){echo "selected"; $supplier_state_id = $key->state_id;} ?>><?php echo $key->first_name." ".$key->last_name; ?></option>
                                  <?php
                                      }
                                  ?>
                          </select>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                      ...
                      <tbody>
                        <?php
                          ...
                          <tr>
                            ...
                            <td>
                              <input type="number" class="form-control text-center" value="<?php echo $key->quantity ?>" data-rule="quantity" name='qty'.$i id='qty'.$i min="1">
                            </td>
                            <td>
                    ...
                    <table class="table table-striped table-bordered table-condensed table-hover">
                      <tr>
                        <td align="right" width="80%"><?php echo $this->lang->line('purchase_total_value')."(Excluding Tax & Discount)"; ?></td>
    ...
    function add_row(data){
      var flag = 0;
            ...
            if(flag == 0){
              ...
              var price = data[0].cost-data[0].add_service_value;
