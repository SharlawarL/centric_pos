      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" href="<?php echo base_url('ledger/report');?>" title="Ledger Report" onclick="">Ledger Report <!-- <?php echo $this->lang->line('branch_label_newbranch'); ?> --></a>
