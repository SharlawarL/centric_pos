                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('ledger/edit') ?>">
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" placeholder="Opening Date" id="opening_date" name="opening_date" value="<?php echo $ledger->opening_date; ?>"> 
                    </div>
                    <div class="form-group">
                      <label   for="opening_balance">End Date</label>
                      <input type="date" class="form-control" placeholder="End Date" id="end_date" name="end_date" value="<?php echo $ledger->end_date; ?>"> 
                    </div>
