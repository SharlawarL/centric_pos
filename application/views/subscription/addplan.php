          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('subscription/addPlan');?>" encType="multipart/form-data">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" form="form" wrap="soft" class="form-control" id="plan_desc" name="plan_desc" style="height: 100px; resize:none;"></textarea>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="plan_price" name="plan_price" placeholder="eg: 10.00">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <label for="plan_duration">Duration (months)<span class="validation-color"> *</span></label>
                      <input type="text" class="form-control" id="plan_duration" name="plan_duration" placeholder="eg: 12">
                  ...
                  <div class="col-sm-12">
                    <div class="box-footer">
                      ...
                      <button type="submit" id="submit" class="btn btn-info p-5">Submit</button>
                      <span class="btn btn-default" id="cancel" style="margin-left: 2%" onclick="cancel('subscription')"><?php echo $this->lang->line('product_cancel'); ?></span>
