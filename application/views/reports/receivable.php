                    ...
                    <select class="form-control select2" id="customer" name="customer" style="width: 100%;">
                      ...
                      <?php
                        ...
                        foreach ($customers as $row) {
                          echo "<option value='$row->id'".set_select('customer_id',$row->id).">$row->user_name</option>";
                        }
                      ?>
                    </select>
                    <span class="validation-color" id="err_customer"><?php echo form_error('customers'); ?></span>
                  </div>
                </div>
                <div class="col-md-12">
