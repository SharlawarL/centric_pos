        		...
        		?>
	           	...
	           	?>
		              	<div class="box-body">
			              	...
			              	<div class="row">
			              		<div class="col-md-6">
					                  ...
					                  <input type="number" class="form-control" id="quantity" name="quantity" placeholder="0.00" step="0.01" value="<?php if(isset($stock->quantity)) echo $stock->quantity;?>" required>
					                </div>		                
			              		</div>
			              	</div>
			              	<div class="row">
		              	...
		              	<div class="box-footer">
			                ...
			                <span class="btn btn-default" id="cancel" style="margin-left: 2%" onclick="cancel('stock')"><!-- Cancel --> <?php echo $this->lang->line('branch_label_cancel'); ?></span>
			            </div>
		            </form>
		        </div> 	 
	        </div>
