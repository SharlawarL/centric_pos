                 ...
                 <?php foreach($data as $row){?>
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="barcode_id" name="barcode_id" value="<?php echo set_value('barcode_id',$row->barcode_id); ?>" readonly>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="sku" name="sku" value="<?php echo set_value('sku',$row->sku); ?>">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="add_service_value" name="add_service_value" value="<?php echo set_value('add_service_value',$row->add_service_value); ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="cost" name="cost" value="<?php echo $row->cost-$row->add_service_value;?>">
