        ...
        <div class="col-md-9">
            ...
            <div class="box">
              ...
              ?>
                  ...
                  <a href="<?php echo base_url('barcode/print_barcode');?>" target="_blank" class="btn btn-sm btn-default btn-flat pull-right" style="margin-right: 10px" href="<?php echo base_url('product/products_barcode');?>">
                    Products Barcode
                  </a>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th style="font-size: 12px;"> 
                          <?php 
                              echo  $this->lang->line('product_code')." /<br/>".
                                    $this->lang->line('product_hsn_sac_code')." /<br/>".
                      ...
                      <th style="font-size: 12px;"><?php echo $this->lang->line('product_sku'); ?></th>
                      ...
                      <tr>
                       ...
                       <!--  <td width="5%"><img src="<?php if($row->image == null) {echo base_url('assets/images')."/no_image.png";}else{echo $row->image;} ?>" width="100%" height="10%"></td> -->
                        ...
                        <td><?php 
                          ...
                          if($this->session->userdata('type')=="sales_person" || $this->session->userdata('type')=="purchaser"){
                            echo $row->w_quantity;     
