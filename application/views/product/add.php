              ...
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('product/addProduct');?>" encType="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="barcode_id"><?php echo $this->lang->line('product_barcode_id'); ?><span class="validation-color">*</span></label>
                      <input type="text" class="form-control" id="barcode_id" name="barcode_id" value="<?php echo set_value('barcode_id',strtoupper(substr(md5(time()), 0, 15))); ?>" readonly>
                      <span class="validation-color" id="err_barcode_id"><?php echo form_error('barcode_id'); ?></span>
                    </div>

                    <div class="form-group">
                      <label for="sku"><?php echo $this->lang->line('product_sku'); ?><span class="validation-color">*</span></label>
                      <input type="text" class="form-control" id="sku" name="sku" value="<?php echo set_value('sku'); ?>">
                      <span class="validation-color" id="err_sku"><?php echo form_error('sku'); ?></span>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" id="unit" name="unit" required="required">
                        ...
                        ?>
                            <option value='<?=$value->id?>' 
                              ...
                              ?>
                            ><?=$value->uom.' - '.$value->description?></option>;
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <label for="add_service_value"><?php echo $this->lang->line('product_product_add_service_value'); ?> <span class="validation-color">*</span></label>
                      <input type="text" class="form-control" id="add_service_value" name="add_service_value" value="<?php echo set_value('add_service_value',0); ?>">
                      <span class="validation-color" id="err_add_service_value"><?php echo form_error('add_service_value'); ?></span>
                    </div>
                    <div class="form-group">
                      <label for="cost"><?php echo $this->lang->line('product_product_cost'); ?> <span class="validation-color">*</span></label>
                      <input type="text" class="form-control" id="cost" name="cost" value="<?php echo set_value('cost',0); ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="price" name="price" value="<?php echo set_value('price',0); ?>">
                    ...
                    <div class="form-group">
                      ...
                      <span class="validation-color" id="err_alert_quantity"><?php echo form_error('alert_quantity',0); ?></span>
                    </div>
                    <div class="form-group">
                      <label for="igst">SST %</label>
                      <input type="text" class="form-control" id="igst" name="igst" value="<?php echo set_value('igst',0); ?>">
                      <span class="validation-color" id="err_igst"><?php echo form_error('igst'); ?></span>
                    </div>

               <!--    <div class="form-group">
                      <label for="cgst">CGST %</label>
                      <input type="text" class="form-control" id="cgst" name="cgst" value="<?php echo set_value('cgst',0); ?>">
                      <span class="validation-color" id="err_cgst"><?php echo form_error('cgst'); ?></span>
                    </div>

                    <div class="form-group">
                      <label for="sgst">SGST %</label>
                      <input type="text" class="form-control" id="sgst" name="sgst" value="<?php echo set_value('sgst',0); ?>">
                    ...
                    <div class="form-group">
                      <label for="serial_no"><?php echo $this->lang->line('product_serial_no'); ?> </label>
                      <input type="text" class="form-control" id="serial_no" name="serial_no" value="<?php echo set_value('serial_no'); ?>">
                      <span class="validation-color" id="err_serial_no"><?php echo form_error('serial_no'); ?></span>
                    </div>
  ...
  $(document).ready(function(){
    $("#submit").click(function(event){
      ...
      var details = $('#details').val();
        ...
        if(code.indexOf(' ') >= 0){
          $('#err_code').text("Space is not allowed in product code.")
          return false;;  
        }

        if (!code.match(sname_regex) ) {
          $('#err_code').text("Only Alphanumeric value is allowed.");  
          return false;
        }
        else{
          $("#err_code").text("");
        ...
        if(sku==null || sku==""){
          ...
          $("#err_sku").text("Please Enter Product SKU.");
          return false;
        }
        else{
          $("#err_sku").text("");
...
//porduct price validation complite.
    ...
    $("#sku").on("blur keyup",  function (event){

        var sku = $('#sku').val();
        if(sku==null || sku==""){
          $("#err_sku").text("Please Enter Product Code.");
          return false;
        }
        else{
          $("#err_sku").text("");
