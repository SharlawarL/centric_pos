			              	...
			              	<div class="row">
			              		<div class="col-md-8">
					                  ...
					                  <input type="text" class="form-control" id="name" name="name" placeholder="Enter Role" value="<?php if(isset($role->name)) echo $role->name;?>" 
					                  		...
					                  		?>>
                                <span class="validation-color" id="role_name_error"><?php echo form_error('name'); ?></span>
					                </div>		
			              		</div>
			              	</div>
			              	<div class="row">
			              		<div class="col-md-8">
									  ...
									  <span class="validation-color" id="description_error"><?php echo form_error('description'); ?></span>
					                </div>		                
			              		</div>
			              	</div>
		              	</div>
