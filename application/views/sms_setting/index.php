        ...
        <div class="col-md-9">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">SMS Setting (Only msg91 is supported now)</h3>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="box-body">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <a href="https://msg91.com/signup/172c27b31a" target="_blank"><img src="<?php echo base_url('assets/images')."/msg91.png" ?>" height="120px" width="100%"></a>
                            </div>
                          </div>
                        </div>
                        <!-- /.box-body -->
                                ...
                                <div id="configure" class="panel-collapse collapse in" aria-expanded="true">
                                  <div class="box-body">
                                    <table class="table table-bordered">
                                      ...
                                      <tr>
                                        <td>Step 3</td>
                                        <td>Copy auth key from MSG91 to abcd SMS Setting.<br/> <a href="http://nimb.ws/FOolxr" target="_blank">Click here for information </a></td>
                                      </tr>
                                      <tr>
                                        <td>Step 4</td>
                                        <td>Save the auth key to abcd > SMS Setting <br/> <a href="http://nimb.ws/PpxYdC" target="_blank">Click here for information </a></td>
                                      </tr>
                                    </table>
                                  </div>
