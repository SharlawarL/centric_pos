  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b><?php echo $this->lang->line('dashboard_version'); ?></b> 3.1
    </div>
    <strong><?php echo $this->lang->line('dashboard_copyright'); ?> &copy; <?php echo date('Y'); ?> <a href="" target=""></a>.</strong> All <?php echo $this->lang->line('dashboard_rights_reserved'); ?>
  </footer>
<!-- ./wrapper -->
<!-- Control Sidebar -->
