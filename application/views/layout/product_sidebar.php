  ...
  <div class="box box-solid">
    ...
    <div class="box-body no-padding">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li <?php if($this->uri->segment(1)=='product') echo "class='active'"; ?>><a href="<?=base_url('product')?>"><i class="fa fa-product-hunt"></i> Product</a></li>          
          <?php } ?>
          ...
          <li <?php if($this->uri->segment(1)=='category') echo "class='active'"; ?>><a href="<?=base_url('category')?>"><i class="fa fa-angle-double-right"></i> Category</a></li>
          <?php } ?>
          ...
          <li <?php if($this->uri->segment(2)=='import') echo "class='active'"; ?>><a href="<?=base_url('product/import')?>"><i class="fa fa-upload"></i> Product Import</a></li>
          <?php } ?>
        </ul>
    </div>
    <!-- /.box-body -->
