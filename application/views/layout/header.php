...
<div class="wrapper">
              ...
              <!-- <li class="user-body"> -->
                <!-- <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url('auth/dashboard'); ?>">abcdry</a>
                  </div>
                  <div class="col-xs-4 text-center">
 ...
 -->
        ...
        <li class="treeview <?php if($this->uri->segment(1)=='subscription'){ echo 'active'; } ?>">
        ...
        <li class="treeview <?php if($this->uri->segment(1)=='reports'){ echo 'active'; } ?>">
          ...
          <ul class="treeview-menu">
            ...
            <?php ?>  
            <li class="treeview">
            <?php if($this->user_model->has_permission("sst_report")){ ?>  
              <a href="<?php echo base_url('reports/sst'); ?>">
                <i class="fa fa-square text-green"></i>
                <span>SST</span>
              </a>
            </li>
        ...
        <!-- <li class="treeview">
          <a href="https://abcd.net/item/abcd-accounting-billing-abcdry-management-system/20233171" target="_blank">
            <span><a href=" https://abcd.net/item/abcd-accounting-billing-abcdry-management-system/20233171?ref=dhaval28691" class="btn btn-danger btn-block btn-flat" target="_blank">Buy Now</a></span>
          </a>
        </li> -->
      </ul>
    </section>
