                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        if ($user_type=='sales_person') { ?>
                          ...
                          <input type="hidden" name="warehouse" id="warehouse" value="<?php if(isset($biller[0]->warehouse)){ echo $biller[0]->warehouse; } ?>" >

                          <input type="hidden" name="biller" id="biller" value="<?php if(isset($biller[0]->id)){ echo $biller[0]->id; } ?>" >
                          <input type="hidden" name="biller_state_id" id="biller_state_id" value="<?php if(isset($biller[0]->biller_state_id)){ echo $warehouse[0]->biller_state_id; } ?>" >
                          <input type="hidden" name="user_id" id="user_id" value="<?php if(isset($biller[0]->user_id)){echo $biller[0]->id ;} ?>" >
                        <?php  }
                        ...
                        <select class="form-control select2" id="user_id" name="user_id" style="width: 100%;">
                          ...
                          <?php
                            ...
                            foreach ($warehouse as $value) {
                              if($value->primary_warehouse == 1)
                                $primary_warehouse = $value;
                          ?>
                          <option value="<?php echo $value->user_id ?>" <?php if($value->primary_warehouse == 1){ echo " selected";} ?>><?php echo $value->warehouse_name." (".$value->biller_name.")"; ?><?php if($value->primary_warehouse == 1){ echo " (Primary)";} ?></option>
                          <?php
                            }
                          ?>
                        </select>
                        <input type="hidden" name="biller" id="biller" value="<?=$primary_warehouse->biller?>" >  
                        <input type="hidden" name="biller_state_id" id="biller_state_id" value="<?=$primary_warehouse->biller_state_id?>">
                        <input type="hidden" name="warehouse" id="warehouse" value="<?=$primary_warehouse->warehouse_id?>">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="box-footer">
                      <button type="submit" id="addsubmit"  class="btn btn-info"><?php echo $this->lang->line('product_add'); ?></button>
 ...
 $(document).ready(function(){
    ...
    function add_row(data){
      ...
      $("table.product_table").find('input[name^="product_id"]').each(function () {
            ...
            if(flag == 0){
              ...
              // alert('shipping_country_id '+ shipping_country_id);
              
              //var shipping_state_id = $('#state').val();
              if(biller_state_id==shipping_state_id ){
                if(shipping_country_id == 101){
              ...
              cols += "<td>"
                      +"<textarea class='form-control' data-rule='product_name' placeholder='product_name' name='product_name' id='product_name"+ counter +"'>"+name+"</textarea>" 
                      +"</td>";
    ...
    function calculateDiscountTax(row,data = 0,data1 = 0){
      ...
      if(tax_type =="Inclusive")
      {
        ...
        taxable_value = (sales_total - total_discount)*100/(100 + igst + cgst + sgst);
      ...
      {     
        taxable_value = sales_total - total_discount;
        var igst_tax = taxable_value*igst/100;
        var cgst_tax = taxable_value*cgst/100;
        var sgst_tax = taxable_value*sgst/100;
        var tax = igst_tax+cgst_tax+sgst_tax;
    ...
    function calculateRow(row) {
      ...
      var product_name = row.find('textarea[name^="product_name"]').val();
      ...
      product_data[key].product_name = product_name;
      ...
      if(customer==""){
        ...
        $.ajax({
          ...
          success: function(data){            
            ...
            $('#shipping_country_id').val(data[0].country_id);
          }
        });
      }
    });
