                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" id="customer_id" name="customer_id" style="width: 100%;" disabled>
                          ...
                          ?>
                                  <option value='<?php echo $key->id ?>' <?php if($key->id == $data[0]->customer_id){echo "selected";} ?>><?php echo $key->first_name." ".$key->last_name ?></option>
                          <?php
                              }
                          ?>
                        </select>
                         ...
                         // $product_data = [];
                          ...
                          <tr>
                              <td>
                                ...
                                <td>
                                  <textarea class='form-control' data-rule='product_name' placeholder='product_name' name='product_name' id='product_name'><?php echo $key->product_name ?></textarea>
                                </td>
                              ...
                              ?>
                              <td>
                                <input type="number" step="0.01" name="igst" id="igst" class="form-control" max="100" min="0" value="<?php echo $key->igst; ?>" readonly>
                                <input type="hidden" name="igst_tax" id="igst_tax" class="form-control" value="<?php echo $key->igst_tax; ?>">
                                <span id="igst_tax_lbl" class="pull-right" style="color:red;"><?php echo $key->igst_tax; ?></span>
                              </td>
