      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" href="<?php echo base_url('sales/add');?>" title="Add New Sales" onclick="">Add New Sales <!-- <?php echo $this->lang->line('sales_add_new_sales'); ?> --></a>
