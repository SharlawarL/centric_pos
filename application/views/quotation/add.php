                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          if ($user_type=='sales_person') { ?>
                            ...
                            <input type="hidden" name="warehouse" id="warehouse" value="<?php if(isset($warehouse[0]->warehouse_id)){ echo $warehouse[0]->warehouse_id; } ?>" >

                            <input type="hidden" name="biller" id="biller" value="<?php if(isset($warehouse[0]->biller)){ echo $warehouse[0]->biller; } ?>" >
                            ...
                            <input type="hidden" name="user_id" id="user_id" value="<?php if(isset($warehouse[0]->user_id)){echo $warehouse[0]->user_id ;} ?>" >
                          <?php  }
