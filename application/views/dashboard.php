        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-body">
              ...
              <?php } ?>
              <?php if($this->user_model->has_permission("add_ledger")){ ?>
              <a class="btn btn-app" href="<?php echo base_url('ledger/add'); ?>">
                <?php echo checkEmpty($branch->count); ?>
                <i class="fa fa-edit"></i> Add Opening Balance
              </a>
              <?php } ?>
          ...
          <div class="box">
            <div class="box-body">
              ...
              <?php } ?>
              <?php if($this->user_model->has_permission("add_plan")){ ?>
              <a class="btn btn-app" href="<?php echo base_url('subscription/addplan'); ?>">
                <i class="fa fa-cube text-blue"></i> Add Subscription Plan
              </a>
              <?php } ?>
            </div>
            <!-- /.box-body -->
